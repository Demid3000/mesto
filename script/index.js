// Васап! Я пытался всеми силами исправить ошибки, но стало еще хуже( По этому я не знаю как исправить ошибку с кнопками! У меня каким-то образом связаны инпуты в двух попапов и второй попап вообще не работает! У меня будет отчислене если я пройдц этот проект и следущий. Если можете мне сказать где у меня ошибка, то напишите на какой строчке я делаю не правильно так, как по моей логике все должно работать нормально.
"use strict";
